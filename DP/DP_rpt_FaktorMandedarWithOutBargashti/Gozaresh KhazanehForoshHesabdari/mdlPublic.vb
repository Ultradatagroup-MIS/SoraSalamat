Module mdlPublic
    Public ccGozaresh As Integer = 0
    Public OldccGozaresh As Integer
    ...
    Public strMarkazPakhsh2 As String = ""
    Public strNameMarkazPakhsh As String = ""
    ...
    Public sNoeSanad As Integer
    Public Noe As Integer
    Public sVazeiat As String
    'TaminKonandeh
