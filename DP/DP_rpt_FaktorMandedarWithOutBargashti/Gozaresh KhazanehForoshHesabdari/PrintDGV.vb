            ...
            Do While RowPos <= dgv.Rows.Count - 1
                ...
                Else
                    If NewPage Then
                        ...
                        Dim AzTarikhP As String = " ÇÒ " & objTarikh.SetDateSlash(FaktorMandedarB.mskAzTarikh.Text) & " ÊÇ "
                        Dim TaTarikhP As String = objTarikh.SetDateSlash(FaktorMandedarB.mskTaTarikh.Text)
