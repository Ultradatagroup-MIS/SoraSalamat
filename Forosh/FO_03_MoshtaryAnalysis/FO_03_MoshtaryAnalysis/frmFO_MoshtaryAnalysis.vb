...
#Region "Global Form Code"
    ...
    Private Sub SetTitrGrid()
        ...
        GridEXTitr.CurrentTable.Columns.Item("NoeMoshtary").Caption = "نوع مشتری"
        GridEXTitr.CurrentTable.Columns.Item("NoeMoshtary").Visible = True
        GridEXTitr.CurrentTable.Columns.Item("NoeMoshtary").Width = 90
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("NoeMoshtary").Position = 3
        GridEXTitr.CurrentTable.Columns.GridEX.TableHeaderFormatStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
        ...
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("FaktorShomareh").Position = 4
        ...
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("FaktorTarikhSlash").Position = 5
        ...
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("Modat").Position = 6
        ...
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("MablaghFaktor").Position = 7
        ...
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("PardakhtiForFaktor").Position = 8
        ...
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("MandehFaktor").Position = 9
        GridEXTitr.CurrentTable.Columns.Item("MandehFaktor").FormatString = "###,###"

        GridEXTitr.CurrentTable.Columns.Item("txtVazeiatPishFaktorRozeMoshtary").Caption = "وضعیت روز پیش فاکتور"
        GridEXTitr.CurrentTable.Columns.Item("txtVazeiatPishFaktorRozeMoshtary").Visible = True
        GridEXTitr.CurrentTable.Columns.Item("txtVazeiatPishFaktorRozeMoshtary").Width = 140
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("txtVazeiatPishFaktorRozeMoshtary").Position = 10
        ...
        If chkShowMandehMoshtary.Checked Then
            ...
            GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
            GridEXTitr.CurrentTable.Columns.Item("MandehMoshtary").Position = 11
        ...
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("txtMantagheh").Position = 12
        ...
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("txtMahaleh").Position = 13
        ...
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("TarikhPeigiryNext").Position = 14
        ...
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("ccFaktorTitr").Position = 15
        ...
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("ccMoshtary").Position = 16

        GridEXTitr.CurrentTable.Columns.Item("NoeVazeiat").Caption = "NoeVazeiat"
        GridEXTitr.CurrentTable.Columns.Item("NoeVazeiat").Visible = False
        GridEXTitr.CurrentTable.Columns.Item("NoeVazeiat").Width = 0
        GridEXTitr.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
        GridEXTitr.CurrentTable.Columns.Item("NoeVazeiat").Position = 17
        ...
        For i As Integer = 0 To GridEXTitr.RowCount - 1
            ...
            If GridEXTitr.GetRow(i).Cells("NoeVazeiat").Value = 1 Then
                rowcol.BackColor = Color.LightGreen
                GridEXTitr.GetRow(i).RowStyle = rowcol
            ElseIf GridEXTitr.GetRow(i).Cells("NoeVazeiat").Text = 2 Then
                rowcol.BackColor = Color.Yellow
                GridEXTitr.GetRow(i).RowStyle = rowcol
            ElseIf GridEXTitr.GetRow(i).Cells("NoeVazeiat").Text = 0 Then
...
#End Region
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        If IsNothing(GridEXTitr.DataSource) Then
            MsgBox("گزارشی برای نمایش وجود ندارد...", MsgBoxStyle.Information + MsgBoxStyle.MsgBoxRight + MsgBoxStyle.MsgBoxRtlReading, " گزارش ساز ... ")
            Exit Sub
        End If


        Dim a As New SaveFileDialog
        GridEXExporter1.GridEX = GridEXTitr
        GridEXExporter1.ExportMode = Janus.Windows.GridEX.ExportMode.AllRows
        If a.ShowDialog() = Windows.Forms.DialogResult.OK Then
            Dim st As New IO.FileStream(a.FileName + ".xls", FileMode.Create, FileAccess.Write, FileShare.None)
