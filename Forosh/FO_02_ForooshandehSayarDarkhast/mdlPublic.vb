Module mdlPublic
    ...
    ByRef TedadPishFaktor As Double, ByRef MojodiFely As Double, ByRef MojodiGhabelForosh As Double)
        ...
        Try
            ...
            strSqL &= " AND ccPishFaktorTitr Not in (Select IsNull(ccPishFaktor,0) From tblFO_Faktor) AND svazeiat not in(4010,4338)"
            ...
            strSqL = " Select isnull(Sum(Tedad3),0) As 'TedadKol' From dbo.qryFO_PishFaktorTitrSatr "
            strSqL &= " Where CodeMahal = " & CodeMahalFaal & " AND ccKala = " & ccKala & " And IsForoshGarm = 0 And "
            strSqL &= " ccPishFaktorTitr Not in (Select IsNull(ccPishFaktor,0) From tblFO_Faktor) AND Svazeiat NOT in (4009,4010,4338) AND CodeDoreh = " & CodeDoreh
