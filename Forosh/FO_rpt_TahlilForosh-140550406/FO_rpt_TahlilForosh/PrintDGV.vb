...
Public Class PrintDGV
    ...
    Public Shared Sub Print_DataGridView(ByVal dgv1 As DataGridView, ByVal txtCaption As String)
            ...
            Do While RowPos <= dgv.Rows.Count - 1
                ...
                Else
                    If NewPage Then
                        ...
                        Dim AzTarikhP As String = " ÇÒ " & objTarikh.SetDateSlash(frmFO_ReportTahlilForosh.mskAzTarikh.Text) & " ÊÇ "
                        ...
                        e.Graphics.DrawString(s, New Font(dgv.Font.FontFamily, dgv.Font.Size + 2, FontStyle.Bold), _
                           ...
                           e.MarginBounds.Width).Height - 65)
