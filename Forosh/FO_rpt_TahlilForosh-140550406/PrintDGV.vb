...
Public Class PrintDGV
    ...
    Shared WithEvents tb As ToolStrip
    Private Shared tbt As ToolStripButton
    Private Shared preview As Boolean = False
    ...
    Private Shared txtCaption1 As String
    Private Shared txtCaption1_Details As String
    Private Shared CellHeight1 As Double

    Public Shared Sub Print_DataGridView(ByVal dgv1 As DataGridView, ByVal txtCaption As String, ByVal txtCaption_Details As String)
        Dim ppvw As PrintPreviewDialog

        Try
            ' Getting DataGridView object to print
            dgv = dgv1
            txtCaption1 = txtCaption
            txtCaption1_Details = txtCaption_Details
            ...
            If dlg.chkLand.Checked Then
                ppvw.Document.DefaultPageSettings.Landscape = True
            End If
            ppvw.Document.DefaultPageSettings.Color = True

            CellHeight1 = Val(dlg.txtSatrHeight.Text)

            ppvw.Width = 1024
            ppvw.Height = 768
            ppvw.PrintPreviewControl.Zoom = 1
            ppvw.RightToLeft = RightToLeft.Yes

            ppvw.UseAntiAlias = True
            ppvw.SetDesktopLocation(0, 0)

            tb = DirectCast(ppvw.Controls(1), ToolStrip)
            tb.Items(0).Visible = False
            tb.Items.Add(New System.Windows.Forms.ToolStripSeparator)
            tbt = tb.Items(0)
            tbt = tb.Items.Add(image:=tb.Items(0).Image)
        ...
        End Try
    End Sub
    Private Shared Sub tb_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles tb.MouseDown
        preview = True
    End Sub
    Private Shared Sub tb_ItemClicked(sender As Object, e As ToolStripItemClickedEventArgs) Handles tb.ItemClicked
        If e.ClickedItem.Text = tbt.Text Then
            preview = False
            Dim Result As DialogResult
            Dim pdi As PrintDialog
            pdi = New PrintDialog()
            'pdi.AllowSelection = True
            'pdi.ShowNetwork = True
            'pdi.UseEXDialog = True
            pdi.AllowSomePages = True
            Result = pdi.ShowDialog()
            If Result = DialogResult.OK Then
                Dim PrintDGV As Form
                PrintDGV = New Form()
                PrintDGV.TopMost = False
    ...
    Private Shared Sub PrintDoc_PrintPage(ByVal sender As Object, _
        ...
        Try
            ...
            If PageNo = 1 Then
                For j As Integer = dgv.Columns.Count - 1 To 0 Step -1
                    GridCol = dgv.Columns(j)
                    'For Each GridCol As DataGridViewColumn In dgv.Columns
                    If Not GridCol.Visible Then Continue For
            ...
            Do While RowPos <= dgv.Rows.Count - 1
                ...
                Else
                    If NewPage Then
                        ...
                        e.Graphics.DrawRectangle(Pens.Gray, New Rectangle(e.MarginBounds.Left, 10, e.MarginBounds.Right - e.MarginBounds.Left, 50))

                        Dim s As String = txtCaption1
                        Dim s_Details As String = txtCaption1_Details
                        Dim s1 As String = objTarikh.SetDateSlash(TarikhEmrooz) & " -- " & Now.ToShortTimeString & " -- " & PersonelName & " -- "

                        Dim AzTarikhP As String = " از " & objTarikh.SetDateSlash(frmFO_ReportTahlilForosh.mskAzTarikh.Text) & " تا "
                        Dim TaTarikhP As String = objTarikh.SetDateSlash(frmFO_ReportTahlilForosh.mskTaTarikh.Text)
                        Dim NameSherkat As String = objTools.DLookup("NameSherkat", "tblGL_Sherkat", "CodeSherkat = 1")


                        e.Graphics.DrawString(s, New Font(dgv.Font.FontFamily, dgv.Font.Size + 2, FontStyle.Bold), _
                           Brushes.Black, (e.MarginBounds.Left - 30) + (e.MarginBounds.Width - _
                           ...
                           e.MarginBounds.Width).Height - 85)
                        e.Graphics.DrawString(s_Details, New Font(dgv.Font.FontFamily, dgv.Font.Size, FontStyle.Regular), _
                           Brushes.Black, (e.MarginBounds.Left - 30) + (e.MarginBounds.Width - _
                           e.Graphics.MeasureString(s_Details, New Font(dgv.Font, FontStyle.Bold), _
                           e.MarginBounds.Width).Width), e.MarginBounds.Top - _
                           e.Graphics.MeasureString(PrintTitle, _
                           New Font(New Font(dgv.Font, FontStyle.Bold), FontStyle.Bold), _
                           e.MarginBounds.Width).Height - 55)
                        e.Graphics.DrawString(s1, New Font(dgv.Font.FontFamily, dgv.Font.Size, FontStyle.Regular), _
                           Brushes.Black, (e.MarginBounds.Left) + (e.MarginBounds.Width - _
                           e.Graphics.MeasureString(s1, New Font(dgv.Font, FontStyle.Bold), _
                           e.MarginBounds.Width).Width), e.MarginBounds.Top - _
                           e.Graphics.MeasureString(PrintTitle, _
                           New Font(New Font(dgv.Font, FontStyle.Bold), FontStyle.Bold), _
                                                  e.MarginBounds.Width).Height - 20)
                        e.Graphics.DrawString(NameSherkat, New Font(dgv.Font.FontFamily, dgv.Font.Size, FontStyle.Bold), _
                           Brushes.Black, (e.MarginBounds.Left - 10) + (e.MarginBounds.Width - _
                           e.Graphics.MeasureString(NameSherkat, New Font(dgv.Font, FontStyle.Bold), _
                           e.MarginBounds.Width).Width), e.MarginBounds.Top - _
                           e.Graphics.MeasureString(PrintTitle, _
                           New Font(New Font(dgv.Font, FontStyle.Bold), FontStyle.Bold), _
                                                  e.MarginBounds.Width).Height - 0)
                        e.Graphics.DrawString(AzTarikhP, New Font(dgv.Font.FontFamily, dgv.Font.Size, FontStyle.Regular), _
                           Brushes.Black, (e.MarginBounds.Left - 460) + (e.MarginBounds.Width - _
                           e.Graphics.MeasureString(AzTarikhP, New Font(dgv.Font, FontStyle.Bold), _
                           e.MarginBounds.Width).Width), e.MarginBounds.Top - _
                           e.Graphics.MeasureString(PrintTitle, _
                           New Font(New Font(dgv.Font, FontStyle.Bold), FontStyle.Bold), _
                                                  e.MarginBounds.Width).Height - 0)
                        e.Graphics.DrawString(TaTarikhP, New Font(dgv.Font.FontFamily, dgv.Font.Size, FontStyle.Regular), _
                           Brushes.Black, (e.MarginBounds.Left - 550) + (e.MarginBounds.Width - _
                           e.Graphics.MeasureString(TaTarikhP, New Font(dgv.Font, FontStyle.Bold), _
                           e.MarginBounds.Width).Width), e.MarginBounds.Top - _
                           e.Graphics.MeasureString(PrintTitle, _
                           New Font(New Font(dgv.Font, FontStyle.Bold), FontStyle.Bold), _
                                                  e.MarginBounds.Width).Height - 0)
                        ' Draw Columns
                        tmpTop = e.MarginBounds.Top + 15
                        i = 0
                    ...
                    For j As Integer = GridRow.Cells.Count - 1 To 0 Step -1
                        Cel = GridRow.Cells(j)
                        ...
                        If ColumnTypes(i) Is GetType(DataGridViewTextBoxColumn) OrElse _
                           ColumnTypes(i) Is GetType(DataGridViewLinkColumn) Then
                            ...
                            If Left(Cel.ValueType.Name, 3).ToLower = "int" Then
                                e.Graphics.DrawString(ObjCode.DigitSeprator(Cel.Value.ToString), Cel.InheritedStyle.Font, _
                                                          New SolidBrush(Cel.InheritedStyle.ForeColor), _
                                                          New RectangleF(ColumnLefts(i), tmpTop, ColumnWidths(i), _
                                                          CellHeight), StrFormat)

                            ElseIf Left(Cel.ValueType.Name, 3).ToLower = "dou" Then
                                If (Math.Truncate((Cel.Value - Math.Truncate(Cel.Value)) * 100)) = 0 Then
                                    e.Graphics.DrawString(ObjCode.DigitSeprator(Math.Truncate(Cel.Value).ToString).ToString, Cel.InheritedStyle.Font, _
                                                 New SolidBrush(Cel.InheritedStyle.ForeColor), _
                                                 New RectangleF(ColumnLefts(i), tmpTop, ColumnWidths(i), _
                                                 CellHeight), StrFormat)

                                ElseIf (Math.Truncate((Cel.Value - Math.Truncate(Cel.Value)) * 100)) > 0 And (Math.Truncate((Cel.Value - Math.Truncate(Cel.Value)) * 100)) <= 9 Then
                                    e.Graphics.DrawString(ObjCode.DigitSeprator(Math.Truncate(Cel.Value).ToString) + "/0" + (Math.Truncate((Cel.Value - Math.Truncate(Cel.Value)) * 100)).ToString, Cel.InheritedStyle.Font, _
                                          New SolidBrush(Cel.InheritedStyle.ForeColor), _
                                          New RectangleF(ColumnLefts(i), tmpTop, ColumnWidths(i), _
                                          CellHeight), StrFormat)

                                Else
                                    e.Graphics.DrawString(ObjCode.DigitSeprator(Math.Truncate(Cel.Value).ToString) + "/" + (Math.Truncate((Cel.Value - Math.Truncate(Cel.Value)) * 100)).ToString, Cel.InheritedStyle.Font, _
                                          New SolidBrush(Cel.InheritedStyle.ForeColor), _
                                          New RectangleF(ColumnLefts(i), tmpTop, ColumnWidths(i), _
                                          CellHeight), StrFormat)
                                End If
                            ...
                            '        'Or Left(Cel.ValueType.Name, 3).ToLower = "dou" Then
                            '        e.Graphics.DrawString(ObjCode.DigitSeprator(Cel.Value.ToString), Cel.InheritedStyle.Font, _
                            '                                  New SolidBrush(Cel.InheritedStyle.ForeColor), _
                            '                                  New RectangleF(ColumnLefts(i), tmpTop, ColumnWidths(i), _
                            '                                  CellHeight), StrFormat)
