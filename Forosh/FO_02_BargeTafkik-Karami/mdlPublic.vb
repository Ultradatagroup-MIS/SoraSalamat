Module mdlPublic
    ...
    Public Enums As New UD_Dll.Enums
    Public objSms As New SmsProvider.Sent
    ' Public objsmsParsa As New SmsProvider.SentParsa
    ...
    Public ccTafkikJoze As Long = 0 '8    
