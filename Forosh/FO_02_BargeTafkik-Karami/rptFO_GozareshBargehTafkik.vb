...
Public Class rptFO_GozareshBargehTafkik
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFO_GozareshBargehTafkik.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFO_GozareshBargehTafkik
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFO_GozareshBargehTafkik = New rptFO_GozareshBargehTafkik
        rpt.Site = Me.Site
        Return rpt
    End Function
