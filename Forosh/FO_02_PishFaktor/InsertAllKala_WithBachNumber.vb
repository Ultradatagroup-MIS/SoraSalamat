Public Class InsertAllKala_WithBachNumber
...
#End Region
    Private Sub InsertAllKala_WithBachNumber_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            SetParameter()
    ...
    Public Sub Search(ByVal Type As Boolean) '' True --> Search Koli \\ False --> Load Kardan Safhe Be Sorat Khali
        Try
            ...
            strSQL = "Sales.spPishFaktor_frmInsertAllKala_WithBachNumber_Search "
    ...
    Private Sub RefreshTitrdata(ByVal strSql As String, ByVal Type As Boolean) '' True --> Search Koli \\ False --> Load Kardan Safhe Be Sorat Khali
        ...
        Try
            ...
            cmSQL.Parameters.AddWithValue("AzTarikh", CodeDoreh.ToString & "0101")
            ...
            If Flg_Load = True And dvForm.Count = 0 Then
                MsgBox("کالایی یافت نشد .", MsgBoxStyle.Information + MsgBoxStyle.MsgBoxRight + MsgBoxStyle.MsgBoxRtlReading + MsgBoxStyle.OkOnly, "")
                Me.Close()
            End If
    ...
    Private Sub SetGridStyle()
        Try
            ...
            GridEXInsertKala.CurrentTable.Columns.Item("NameKala").Width = 430
            ...
            GridEXInsertKala.CurrentTable.Columns.Item("ShomarehBach").Caption = "قیمت مصرف کننده"
            GridEXInsertKala.CurrentTable.Columns.Item("ShomarehBach").Visible = True
            GridEXInsertKala.CurrentTable.Columns.Item("ShomarehBach").Width = 115
            'GridEXInsertKala.CurrentTable.Columns.Item("ShomarehBach").EditType = Janus.Windows.GridEX.EditType.NoEdit
            GridEXInsertKala.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
            GridEXInsertKala.CurrentTable.Columns.Item("ShomarehBach").Position = 3
            GridEXInsertKala.CurrentTable.Columns.Item("ShomarehBach").TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            GridEXInsertKala.CurrentTable.Columns.Item("TarikhTolid").Caption = "تاریخ تولید"
            GridEXInsertKala.CurrentTable.Columns.Item("TarikhTolid").Visible = True
            GridEXInsertKala.CurrentTable.Columns.Item("TarikhTolid").Width = 100
            'GridEXInsertKala.CurrentTable.Columns.Item("TarikhTolid").EditType = Janus.Windows.GridEX.EditType.NoEdit
            GridEXInsertKala.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
            GridEXInsertKala.CurrentTable.Columns.Item("TarikhTolid").Position = 4
            GridEXInsertKala.CurrentTable.Columns.Item("TarikhTolid").TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            GridEXInsertKala.CurrentTable.Columns.Item("TarikhEngheza").Caption = "تاریخ انقضا"
            GridEXInsertKala.CurrentTable.Columns.Item("TarikhEngheza").Visible = True
            GridEXInsertKala.CurrentTable.Columns.Item("TarikhEngheza").Width = 100
            'GridEXInsertKala.CurrentTable.Columns.Item("NameKala").EditType = Janus.Windows.GridEX.EditType.NoEdit
            GridEXInsertKala.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
            GridEXInsertKala.CurrentTable.Columns.Item("TarikhEngheza").Position = 5
            GridEXInsertKala.CurrentTable.Columns.Item("TarikhEngheza").TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
            ...
            GridEXInsertKala.CurrentTable.Columns.Item("Tedad").Position = 6
            ...
            GridEXInsertKala.CurrentTable.Columns.Item("Fee").Position = 7
            ...
            GridEXInsertKala.CurrentTable.Columns.Item("MojodiDarHalForosh").Width = 90
            GridEXInsertKala.CurrentTable.Columns.GridEX.EditMode = Janus.Windows.GridEX.EditMode.EditOff
            GridEXInsertKala.CurrentTable.Columns.Item("MojodiDarHalForosh").EditType = Janus.Windows.GridEX.EditType.NoEdit
            GridEXInsertKala.CurrentTable.Columns.Item("MojodiDarHalForosh").Position = 8
    ...
    Private Sub btnEnter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnter.Click
        ...
        For i As Integer = 0 To GridEXInsertKala.RowCount - 1
            If GridEXInsertKala.GetRow(i).Cells("Tedad").Text.Trim <> 0 Then
                InsertKala(Val(GridEXInsertKala.GetRow(i).Cells("ccKala").Text.Trim), GridEXInsertKala.GetRow(i).Cells("CodeKala").Text.Trim, GridEXInsertKala.GetRow(i).Cells("Tedad").Text.Trim, GridEXInsertKala.GetRow(i).Cells("ShomarehBach").Text.Trim, GridEXInsertKala.GetRow(i).Cells("TarikhTolid").Text.Trim, GridEXInsertKala.GetRow(i).Cells("TarikhEngheza").Text.Trim)
            End If
        Next
    ...
    Private Function IsValidEtebar(ByVal MablaghSatr As Double) As Boolean
        ...
        End Try
    End Function
    Private Sub InsertKala(ByVal ccKala As Integer, ByVal CodeKala As String, ByVal Tedad As Double, _
                            ByVal ShomarehBach As String, ByVal TarikhTolid As String, ByVal TarikhEngheza As String)
        Try
            ...
            If objTools.DLookup("PishFaktorAmani", "tblFO_PishFaktor", "ccPishFaktorTitr = " & frm_ccPishFaktor) = True Or objTools.DLookup("PishFaktorGheireGhateei", "tblFO_PishFaktor", "ccPishFaktorTitr = " & frm_ccPishFaktor) = True Then
            ...
            GetMojodiDarHalForosh_WithBachNumber(ccKala, ccAnbarForosh, ShomarehBach, TarikhTolid, TarikhEngheza, MojodiGhabelForosh)

            If Tedad > MojodiGhabelForosh Then
                strKala &= CodeKala & ","
                Exit Sub
            End If
            '' -------------- Control Mojodi --------------
            ...
            strSQL = "Sales.spPishFaktor_frmInsertAllKala_WithBachNumber_InsertKala "
            ...
            cmSQL.Parameters.AddWithValue("ShomarehBach", ShomarehBach)
            cmSQL.Parameters.AddWithValue("TarikhTolid", TarikhTolid)
            cmSQL.Parameters.AddWithValue("TarikhEngheza", TarikhEngheza)
        ...
        End Try
    End Sub
    Private Function GetMojodiDarHalForosh_WithBachNumber(ByVal ccKala As Long, ByVal ccAnbar As Integer, _
                        ByVal ShomarehBach As String, ByVal TarikhTolid As String, ByVal TarikhEngheza As String, _
                        ByRef MojodiGhabelForosh As Double) As Double
        GetMojodiDarHalForosh_WithBachNumber = 0
        ...
        Try
            ...
            strSQL = "Sales.spPishFaktor_frmInsertAllKala_WithBachNumber_MojodiDarHalForosh1Kala "
            ...
            cmSQL.Parameters.AddWithValue("TarikhTolid", TarikhTolid)
            cmSQL.Parameters.AddWithValue("TarikhEngheza", TarikhEngheza)
            cmSQL.Parameters.AddWithValue("MojodyDarHalForosh", MojodiGhabelForosh)
            cmSQL.Parameters("MojodyDarHalForosh").Direction = ParameterDirection.Output

            cmSQL.ExecuteNonQuery()

            MojodiGhabelForosh = cmSQL.Parameters("MojodyDarHalForosh").Value

            cmSQL = Nothing
            cnSQL.Close()

        Catch sqlExc As SqlException
            MsgBox(sqlExc.Message, MsgBoxStyle.OkOnly + MsgBoxStyle.MsgBoxRight + MsgBoxStyle.MsgBoxRtlReading + MsgBoxStyle.Information, " Error IN DataBase ----> GetMojodiDarHalForosh_WithBachNumber ")
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical + MsgBoxStyle.MsgBoxRight + MsgBoxStyle.MsgBoxRtlReading, " Error IN ----> GetMojodiDarHalForosh_WithBachNumber ")
        End Try
    End Function
