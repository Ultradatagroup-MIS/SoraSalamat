Module mdlPublic
    ...
    Public ccMoshtaryExtrnalOpen As Long
    ...
    Public CodeCompany As Integer

    Public Taraf_afrad As Long

    Public noeRep As Integer
    Public noeLoadAddFavorit As Integer

    Public CodeAnbar As Integer
End Module
