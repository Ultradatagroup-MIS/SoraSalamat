Module mdlPublic
    ...
    Public cntCodeSubSystem As Long
    ...
    '        strSqL &= " Where ccKala = " & ccKala & " And "
    '        strSqL &= " ccPishFaktorTitr Not in (Select IsNull(ccPishFaktor,0) From tblFO_Faktor) AND svazeiat <> 4010 AND CodeDoreh = " & CodeDoreh
