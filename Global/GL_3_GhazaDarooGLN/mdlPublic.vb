Module mdlPublic
    ...
    Public strCodeAmalyatPrint As String
    Public NoeChap As Boolean = False 'false= Daryaft   True= Pardakht
    ...
    Public TarikhEmroozMilady As String = objTarikh.Sh2Mi(objTarikh.Mi2Sh(Today))
    ...
    'Codeing
    '
    'Public NoeTafsily As UD_Dll.Enums.Ud_dll.Enums.HE_Tafsily
    ...
    Public TarikhForm As String
    Public TarikhMilady As String
    ...
    Public Sub SetLanguage()
        ...
        table = New DataTable("Language")

        strSQL = " SELECT  *  from  tblGL_Translate where ccLanguage =  " & Language
