Module mdlPublic
    ...
    Public TarikhAvaleDoreh As String
    Public azTarikhGhabl As String
    Public taTarikhGhabl As String
    Public strNoeSanad As String
    Public strMarkazPakhsh As String
    Public Tajmie As Byte

    Public NoTaraz As Boolean
    Public NoBiGardesh As Boolean
    Public strSearch As String = ""
    Public NoeGozaresh As Integer = 0
    Public PubAztarikh As String
    Public PubTatarikh As String
