Module mdlPublic
    ...
    'Public ConnectionString As String = "server=172.16.0.60;initial catalog=DB_Pakhsh_Haraz;user id =sa;pwd =DrwebDDc1"
    ' Input Parameter 
    ...
    Public GrouhKala1 As Integer
    Public GrouhKala2 As Integer
    Public GrouhKala3 As Integer
    '---Search Kala-------------------------------------------
    ...
    Public ccPourcentTitr As Integer = 0
    Public ccPourcentSatr As Integer = 0
    Public AzTarikh As String
    Public TaTarikh As String
    Public FlagSearch As Boolean = False
    Public StepNumber As Integer = 0
    Public FlagInsert As Boolean = False
    Public ccPourcentDeleteTitr As Integer = 0
    Public ccPourcentDeleteSatr As Integer = 0
