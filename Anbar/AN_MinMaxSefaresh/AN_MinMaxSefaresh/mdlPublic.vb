Module mdlPublic
    ...
    Public tSnoeSenf As String
    Public ttxtNoeSenf As String

    '---Takhfif Jayezeh-----------------------------------------

    Public shahrooz As Integer
    Public Takhfif As Integer
    Public TakhfifJaizehNoeMohasebeh As Integer
    Public ccTakhfifJaizeh As Integer
    Public ccTakhfifJaizehNoeMohasebeh As Integer

    Public rdTakhfif As Integer

    Public rdJaizeh As String
    Public CodeNoeMohasebeh As Integer

    Public FromDate As String
    Public Shomareh As Integer
    Public Sharh As String
    Public NameNoeMohasebeh As String
    Public NameKala As String
    Public ShomarehBach As Integer
    Public Tedad As Integer

    Public noeLoad As Integer

    Public noegrouh1 As Integer
    Public noeGrouh2 As Integer
    Public noeGrouh3 As Integer
    Public noeGrouh4 As Integer
    Public noeGrouh5 As Integer
    ...
    ByRef TedadPishFaktor As Double, ByRef MojodiFely As Double, ByRef MojodiGhabelForosh As Double)
        ...
        Try
            ...
            strSqL &= " Where IsForoshGarm = 0 And ccKala = " & ccKala & " And CodeMahal = " & CodeMahalFaal
            ...
            strSqL = " Select isnull(Sum(Tedad3),0) As 'TedadKol' From dbo.qryFO_PishFaktorTitrSatr "
            strSqL &= " Where  IsForoshGarm = 0 And CodeMahal = " & CodeMahalFaal & " AND ccKala = " & ccKala & " And "
            strSqL &= " ccPishFaktorTitr Not in (Select IsNull(ccPishFaktor,0) From tblFO_Faktor) AND Svazeiat NOT in (4010,4338,4009) AND CodeDoreh = " & CodeDoreh
