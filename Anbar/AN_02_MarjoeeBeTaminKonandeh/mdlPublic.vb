Module mdlPublic
    ...
    'ByRef TedadPishFaktor As Double, ByRef MojodiFely As Double, ByRef MojodiGhabelForosh As Double, ByVal TedadAnbarBeAnbar As Double, ByVal TedadHavaleh As Double)
    ...
    '        strSqL &= " Where CodeMahal = " & CodeMahalFaal & " AND ccKala = " & ccKala & " And CodeDoreh= " & CodeDoreh
    ...
    '        strSqL = " Select isnull(Sum(Tedad3),0) As 'TedadKol' From dbo.qryAN_KdxAnbarBeAnbarTitrSatr "
    '        strSqL &= " Where CodeMahal = " & CodeMahalFaal & " AND ccKala = " & ccKala & "And CodeDoreh= " & CodeDoreh
    '        strSqL &= " And svazeiat <> 1 And ccAnbarAz = " & ccAnbar


    '        cmSQL = New SqlCommand(strSqL, cnSQL)
    '        cnSQL.Open()

    '        TedadAnbarBeAnbar = cmSQL.ExecuteScalar
    ...
    '        strSqL = " Select isnull(Sum(Tedad3),0) As 'TedadKol' From dbo.qryAN_kdxHavalehTitrSatr "
    '        strSqL &= " Where CodeMahal = " & CodeMahalFaal & " AND ccKala = " & ccKala & " And CodeDoreh= " & CodeDoreh
    '        strSqL &= " And svazeiat <> 1 And ccAnbar = " & ccAnbar
    ...
    '        TedadHavaleh = cmSQL.ExecuteScalar
    ...
    '        strSqL &= " Where  ccKala = " & ccKala & " And CodeMahal = " & CodeMahalFaal & " AND CodeDoreh= " & CodeDoreh
    '        strSqL &= " AND svazeiat <> 1 And ccAnbar = " & ccAnbar
    ...
    '        strSqL &= " Where CodeMahal = " & CodeMahalFaal & " AND ccKala = " & ccKala & " And "
    '        strSqL &= " ccPishFaktorTitr Not in (Select IsNull(ccPishFaktor,0) From tblFO_Faktor) AND Svazeiat NOT in (4010,4338) AND CodeDoreh = " & CodeDoreh
    ...
    '        MojodiGhabelForoshKOL = (TedadAnbar - (TedadPishFaktor + TedadMarjoeeTaminKonandeh + TedadEshantion + TedadAnbarBeAnbar + TedadHavaleh))
    '        'MojodiGhabelForoshKOL = TedadAnbar
    '        cnSQL.Close() : cnSQL = Nothing
    '    Catch ex As Exception
