            ...
            Do While RowPos <= dgv.Rows.Count - 1
                ...
                Else
                    If NewPage Then
                        ...
                        e.Graphics.DrawString(s, New Font(dgv.Font.FontFamily, dgv.Font.Size + 1, FontStyle.Bold), _
                           Brushes.Black, (e.MarginBounds.Left - 60) + (e.MarginBounds.Width - _
                    ...
                    For j As Integer = GridRow.Cells.Count - 1 To 0 Step -1
                        ...
                        '                             e.Graphics.DrawString(ObjCode.DigitSeprator(Math.Truncate(Cel.Value).ToString) + "," + (Cel.Value - Math.Truncate(Cel.Value)).ToString, Cel.InheritedStyle.Font, _
                        '                                                       New SolidBrush(Cel.InheritedStyle.ForeColor), _
                        '                                                       New RectangleF(ColumnLefts(i), tmpTop, ColumnWidths(i), _
                        '                                                       CellHeight), StrFormat)
                        '                         Else
